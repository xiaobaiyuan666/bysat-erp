...
return [
    ...
    'Website'                                                                                               => '系统名称',
    'My Website'                                                                                            => 'ERP AI 管理系统',
    'Install now'                                                                                           => '点击安装',
    'Installing'                                                                                            => '安装中...',
    'Home'                                                                                                  => '访问首页',
    'Dashboard'                                                                                             => '进入后台',
    'Install Mode'                                                                                          => '安装模式',
    'Clean Install'                                                                                         => '正式环境（纯净安装）',
    'Demo Install'                                                                                          => '演示体验（带测试数据）',
    'Install mode help'                                                                                     => '正式上线建议选择纯净安装；如果只是内部演示、培训或体验，再选择演示安装。',
    'Existing database tips'                                                                                => '不要求 root；如果当前账号没有建库权限，请先在宝塔创建数据库并授权后再安装。',
    'First Use Guide'                                                                                       => '首次使用说明',
    'Deployment Guide'                                                                                      => '部署与升级说明',
    'Official installer mode'                                                                               => '当前页面已切回 FastAdmin 官方安装流程，并适配 ERP 正式版数据包。',
    'Go back'                                                                                               => '返回上一页',
