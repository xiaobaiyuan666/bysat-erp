...
return [
    ...
    'Category1' => '分类一',
    'Category2' => '分类二',
    'Rule tips' => '校验规则请参考 nice-validator 文档',
    ...
    'Name already exist' => '变量名称已存在',
    'Add new config' => '点击添加新的配置',
    'Send a test message' => '发送测试邮件',
    'Only work at development environment' => '只允许在开发环境执行此操作',
    'This is a test mail content' => '这是一封来自 %s 的测试邮件，用于校验邮件配置是否正常',
    'This is a test mail' => '这是一封测试邮件',
    'Please input your email' => '请输入测试接收邮箱',
